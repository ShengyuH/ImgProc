...
This repository follows Bildverarbeitung FS2021 for Geomatik bachelor students at ETH Zurich. Lectures and recordings can be found in [Moodle](https://moodle-app2.let.ethz.ch/course/view.php?id=14695). 
...
```
git clone https://github.com/ShengyuH/ImgProc.git
``` 
...
Please uninstall ```opencv_python``` and instead, install ```opencv_python_headless```:
```
